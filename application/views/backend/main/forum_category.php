...
<script>
    ...
    function save2(e){
        ...
        jQuery.ajax({
            type: "POST",
            url: "<?= site_url('admin/saveForumCategory') ?>",
            data:formData,
            dataType:'json',
            processData:false,
            contentType: false,
    ...
    function forum_category_view(id){

        jQuery.ajax({
            type: "POST",
            url: "<?= site_url('admin/forum_category_view') ?>",
            data:{id:id},
            success: function(data) {     
                $("#dataView").html(data)
            }
    ...
    function editForumCategory(id){
      ...
      document.getElementById('form2').reset();
       $("#hidden_id").val("")
        jQuery.ajax({
            type: "POST",
            url: "<?= site_url('admin/editForumCategory') ?>",
            data:{id:id},
            dataType:'json',
            success: function(data) {     
              $("#hidden_id").val(id)
    ...
    function deleteForumCategory(id){
      ...
      var conf=confirm("Are you sure you want to delete forum category ?")
      if(!conf){
        return
      }
      ...
      jQuery.ajax({
          type: "POST",
          url: "<?= site_url('admin/deleteForumCategory') ?>",
          data:{id:id},
          dataType:'json',
