...
<script>
    ...
    function save2(e){
        ...
        jQuery.ajax({
            type: "POST",
            url: "<?= site_url('admin/saveNewsCategory') ?>",
            data:formData,
            dataType:'json',
            processData:false,
            contentType: false,
    ...
    function news_category_view(id){

        jQuery.ajax({
            type: "POST",
            url: "<?= site_url('admin/news_category_view') ?>",
            data:{id:id},
            success: function(data) {     
                $("#dataView").html(data)
            }
    ...
    function editNewsCategory(id){
      ...
      document.getElementById('form2').reset();
       $("#hidden_id").val("")
        jQuery.ajax({
            type: "POST",
            url: "<?= site_url('admin/editNewsCategory') ?>",
            data:{id:id},
            dataType:'json',
            success: function(data) {     
              $("#hidden_id").val(id)
    ...
    function deleteNewsCategory(id){
      ...
      var conf=confirm("Are you sure you want to delete news category ?")
      if(!conf){
        return
      }
      ...
      jQuery.ajax({
          type: "POST",
          url: "<?= site_url('admin/deleteNewsCategory') ?>",
          data:{id:id},
          dataType:'json',
